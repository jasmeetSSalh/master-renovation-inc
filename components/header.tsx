          ...
          <Sheet>
            ...
            <SheetContent side="left" className="bg-black text-white w-64 p-6">
              <nav className="flex flex-col gap-4">
                <a href="#about" className="text-sm hover:text-gray-400 transition-colors">
                  About Us
                </a>
                <a href="#services" className="text-sm hover:text-gray-400 transition-colors">
                  Services
                </a>
                <a href="#projects" className="text-sm hover:text-gray-400 transition-colors">
                  Projects
                </a>
